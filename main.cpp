...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Davincicoin-seeder\n"
...
static const string mainnet_seeds[] = {"node01.davincicodes.net", ""};
static const string testnet_seeds[] = {"node01.davincicodes.net",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("200.1.0.2", GetDefaultPort()), true); //CHANGE IN FINAL RELEASE TO FINAL SEEDER###
  }
  do {
...
int main(int argc, char **argv) {
  ...
  if (opts.fUseTestNet) { //TESTNET MESSAGE START
